...
- [ ] 2. モーダルヘッダのレスポンシブ対応を実装する
- [ ] 2.1 ヘッダのパディングとフォントサイズをモバイル向けに最適化する
...
- [ ] 3. カテゴリとタグのラベル表示をレスポンシブ対応する
- [ ] 3.1 ラベルの改行防止とオーバーフロー処理を実装する
